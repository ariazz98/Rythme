...
import com.aria.rythme.core.extensions.FixedMotionDurationScale.scaleFactor
import com.aria.rythme.core.extensions.MarqueeAnimationMode.Companion.Immediately
import com.aria.rythme.core.extensions.MarqueeAnimationMode.Companion.WhileFocused
import com.aria.rythme.core.extensions.MarqueeDefaults.Spacing
import com.aria.rythme.core.extensions.MarqueeDefaults.Velocity
...
import androidx.compose.ui.unit.dp
import com.aria.rythme.core.extensions.MarqueeDefaults.Iterations
import com.aria.rythme.core.extensions.MarqueeDefaults.RepeatDelayMillis
...
/**
 * Namespace for constants representing the default values for various [customMarquee] parameters.
 */
object MarqueeDefaults {
    ...
    val RepeatDelayMillis: Int = 4_000

    /** Default value for the `spacing` parameter to [customMarquee]. */
    // From
    ...
    /** Default value for the `velocity` parameter to [customMarquee]. */
    // From
 ...
 *   [androidx.compose.foundation.focusable]. Note that the [initialDelayMillis] is part of the animation, so this parameter
...
private fun velocityBasedTween(
    ...
    return tween(
        ...
        easing = CubicBezierEasing(0.6f, 0.9f, 0.5f, 1f),
        delayMillis = delayMillis
    )
}

/** Specifies when the [customMarquee] animation runs. */
@JvmInline
...
/**
 * Defines a [calculateSpacing] method that determines the space after the end of [customMarquee]
 * content before drawing the content again.
 */
@Stable
fun interface MarqueeSpacing {
    /**
     * Calculates the space after the end of [customMarquee] content before drawing the content
     * again.
     *
